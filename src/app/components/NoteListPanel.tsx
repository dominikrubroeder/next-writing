...
import { INote } from "@/app/components/NoteEditorComponent";
...
export const notes: INote[] = [
  {
    ...
    href: "/note/the-land-of-the-rising-sun-the-enchanting-beauty-of-japan",
  },
  {
    id: 2,
    title: "The Land of the rising sun: The Enchanting Beauty of Japan",
...
export default function NoteListPanel({ activeNote }: { activeNote: number }) {
  return (
    <div className="space-y-6 overflow-y-auto border-x px-6 py-6">
      ...
      <div className="sticky top-0 bg-white py-4">2024</div>
        ...
        {notes.map((note, index) => (
          <li key={note.id}>
            <Link
              ...
              className={`grid gap-1 rounded-md px-4 py-4 transition hover:bg-neutral-100 ${index === activeNote - 1 ? "bg-neutral-100" : "bg-white"}`}
              scroll={false}
              prefetch
            >
